...
2026-06-28 한콘연 온라인 특강 **NotebookLM A to Z** 후기 선물 페이지 정적 파일입니다.

## Files

- `index.html` — 후기선물 안내 페이지 (요약본 + 강의 링크 + 복사해서 쓰는 프롬프트)
- `buyer.html` — 구매선물 안내 페이지 (바로 열기 링크 + 복사해서 쓰는 프롬프트)
...
- 후기선물 페이지는 `summary.html` 요약본, 강의에서 나온 링크, 복사해서 쓰는 프롬프트를 제공합니다.
- 구매선물 페이지는 바로 열기 링크와 복사해서 쓰는 프롬프트만 제공합니다.
